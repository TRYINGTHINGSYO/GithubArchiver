...
export const DAEMON_JOB_INTERVALS: Record<ScheduledJobName, number> = {
	...
	homepage_readiness: Number(process.env.DAEMON_HOMEPAGE_READINESS_INTERVAL_MS ?? 10 * MINUTE),
	...
	semantic_index: Number(process.env.DAEMON_SEMANTIC_INDEX_INTERVAL_MS ?? 5 * MINUTE)
};
