...
- **2026-07-18** · `decision` · `confirmed` · `permanent` · `verified` · `memory`, `adoption` — [Knowledge engine enters maintenance mode](entries/2026-07-18-decision-knowledge-engine-maintenance.md)
