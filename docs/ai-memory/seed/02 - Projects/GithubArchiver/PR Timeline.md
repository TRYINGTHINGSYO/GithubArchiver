...
- **2026-07-17** · `feature` · PR #1 · `68e7572` · `merged` · `discovery`, `daemon`, `ingest` — [Complete autonomous discovery pipeline in production daemon](entries/2026-07-17-pr-1-discovery-pipeline.md)
