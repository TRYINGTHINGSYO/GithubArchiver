...
- **2026-07-18** · `feature` · `confirmed` · `permanent` · PR #12 · `open` · `memory` — [Multi-stage retrieval with typed edges and token budgets](entries/2026-07-18-pr-12-multistage-retrieval.md)
