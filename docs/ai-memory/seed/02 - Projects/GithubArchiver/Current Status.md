...
- **2026-07-18** · `feature` · `confirmed` · `permanent` · PR #13 · `ac157f3` · `open` · `memory` — [Stabilize knowledge engine with evals, explanations, and schema version](entries/2026-07-18-pr-13-stabilize-retrieval.md)
